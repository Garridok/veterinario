  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
            ...
            <div className="mb-5">
                <label htmlFor="sintomas" className="block text-gray-700 uppercase font-bold mb-2">Describe los sintomas</label>
                <textarea name="sintomas" id="sintomas"  cols="40" rows="3"placeholder="Describa los sintomas del animal" value={sintomas} onChange= { (e) => setSintomas(e.target.value)}/>
            </div>
